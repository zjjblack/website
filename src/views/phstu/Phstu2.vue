<template>
  <div class="container">
    <nav>
      <ul class="mcd-menu">
        <li> <a href=""> <i class="fa fa-home"></i> <strong>Home</strong> <small>sweet home</small> </a> </li>
        <li> <a href="" class="active"> <i class="fa fa-edit"></i> <strong>About us</strong> <small>sweet home</small> </a> </li>
        ...
        <li> <a href=""> <i class="fa fa-comments-o"></i> <strong>Blog</strong> <small>what they say</small> </a>
          <ul>
...
<style scoped>
  @import "../../assets/css/phstu/style.css";
  @import url("http://www.jq22.com/jquery/font-awesome.4.6.0.css");
  @import url("http://puertokhalid.com/up/demos/puerto-Mega_Menu/css/normalize.css");
</style>
